...
const MOCK_GROUPS: (Group & { member_count: number })[] = [
  ...
  { id: "8", name: "Brooklyn Home Fellowship", description: "", leader_id: "u8", category: "home-meeting", meeting_day: "Friday", meeting_time: "7:30 PM", location: "Mitchell Residence", max_members: 12, cover_image_url: null, is_open: true, created_at: "", member_count: 8, leader: { full_name: "Pastor Jacoub", avatar_url: null } },
];
