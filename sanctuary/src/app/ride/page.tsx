...
const MOCK_OFFERS: RideOffer[] = [
  { id: "1", driver_id: "u1", pickup_address: "123 Oak Street, Brooklyn", pickup_lat: 40.6501, pickup_lng: -73.9496, service_time: "2026-06-19T09:00:00Z", seats_available: 3, seats_remaining: 2, notes: "Happy to pick up along the route!", status: "open", created_at: "", distance_km: 1.2, driver: { full_name: "Marcus Thompson", avatar_url: null, phone: null } },
  { id: "2", driver_id: "u2", pickup_address: "45 Maple Ave, Queens", pickup_lat: 40.7282, pickup_lng: -73.7949, service_time: "2026-06-19T09:00:00Z", seats_available: 4, seats_remaining: 3, notes: "Leaving at 8:15 AM sharp.", status: "open", created_at: "", distance_km: 2.8, driver: { full_name: "Sarah Okafor", avatar_url: null, phone: null } },
  { id: "3", driver_id: "u3", pickup_address: "89 Church Road, Manhattan", pickup_lat: 40.7614, pickup_lng: -73.9776, service_time: "2026-06-19T11:00:00Z", seats_available: 2, seats_remaining: 1, notes: "11 AM service only. Air-conditioned car.", status: "open", created_at: "", distance_km: 0.7, driver: { full_name: "James Rivera", avatar_url: null, phone: null } },
];
...
function RidePageContent() {
  ...
  const onRequestSubmit = async (data: RequestForm) => {
    ...
    setSearchResults(MOCK_OFFERS.filter((o) => {
      if (data.service === "fri-9") return o.service_time.includes("09:00");
      if (data.service === "fri-11") return o.service_time.includes("11:00");
      return true;
    }));
    setLoading(false);
  };
