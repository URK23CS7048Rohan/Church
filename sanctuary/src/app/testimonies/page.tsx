...
export default function TestimoniesPage() {
  ...
  const fetchTestimonies = async () => {
    try {
      ...
      setTestimonies([
        { id: "1", author_name: "Sarah Jenkins", title: "Healed from Chronic Pain", content: "After years of struggling with severe back pain, the prayer team prayed over me at a Friday service. Two days later, all pain vanished! The doctors are baffled, but I know it's a miracle.", created_at: "2026-06-01" },
