...
const MOCK_GROUPS: (Group & { member_count: number })[] = [
  ...
  { id: "4", name: "Women of Worth", description: "", leader_id: "u4", category: "women", meeting_day: "Tuesday", meeting_time: "6:30 PM", location: "Prayer Room", max_members: 30, cover_image_url: null, is_open: true, created_at: "", member_count: 27, leader: { full_name: "Pastor Jacoub", avatar_url: null } },
  ...
  { id: "6", name: "Youth Life", description: "", leader_id: "u6", category: "youth", meeting_day: "Friday", meeting_time: "12:30 PM", location: "Youth Room", max_members: 40, cover_image_url: null, is_open: false, created_at: "", member_count: 38, leader: { full_name: "James Rivera", avatar_url: null } },
  { id: "7", name: "Romans Inductive Study", description: "", leader_id: "u7", category: "bible-study", meeting_day: "Monday", meeting_time: "7:00 PM", location: "Room 105", max_members: 15, cover_image_url: null, is_open: true, created_at: "", member_count: 10, leader: { full_name: "Pastor Reni Peter", avatar_url: null } },
  { id: "8", name: "Brooklyn Home Fellowship", description: "", leader_id: "u8", category: "home-meeting", meeting_day: "Friday", meeting_time: "7:30 PM", location: "Jacoub Residence", max_members: 12, cover_image_url: null, is_open: true, created_at: "", member_count: 8, leader: { full_name: "John & Pastor Jacoub", avatar_url: null } },
];
