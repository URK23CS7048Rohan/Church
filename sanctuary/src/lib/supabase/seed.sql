...
('a0b1c2d3-e4f5-6a7b-8c9d-0e1f2a3b4c5d', 'The Power of Grace', '2026-06-07', 'Pastor Reni Peter', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 'An inspiring sermon on the depths of God''s grace and how it sustains us in difficult times.', 'Grace Unmeasured', NOW() - INTERVAL '7 days'),
('b0c1d2e3-f4a5-6b7c-8d9e-0f1a2b3c4d5e', 'Walking in Faith', '2026-05-31', 'Pastor Reni Peter', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 'A study on Abraham''s journey of faith and how we can apply those lessons to our modern daily struggles.', 'Living by Faith', NOW() - INTERVAL '14 days'),
('c0d1e2f3-a4b5-6c7d-8e9f-0a1b2c3d4e5f', 'Serving Our Neighbors', '2026-05-24', 'Pastor Jacoub', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 'A challenging message calling us to step outside the walls of the church to serve our local community.', 'Outreach & Love', NOW() - INTERVAL '21 days');
...
('e4f5a6b7-c8d9-0e1f-2a3b-4c5d6e7f8a9b', NULL, 'Sarah Jenkins', 'Healed from Chronic Pain', 'After years of struggling with severe back pain, the prayer team prayed over me at a Friday service. Two days later, all pain vanished! The doctors are baffled, but I know it''s a miracle.', TRUE, NOW() - INTERVAL '3 days'),
